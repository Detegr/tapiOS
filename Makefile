OBJECTS=boot/loader.o boot/paging_asm.o util/util_asm.o terminal/vga.o irq/gdt.o irq/idt.o irq/pic.o irq/irq_asm.o irq/irq.o util/util.o mem/kmalloc.o mem/pmm.o mem/vmm.o kmain.o util/scancodes.o task/process.o task/multitasking.o irq/timer.o syscall/syscalls.o fs/vfs.o fs/ext2.o task/processtree.o task/scheduler.o fs/devfs.o drivers/tty.o drivers/keyboard.o
